        ...
        while (true) {
            ...
            switch (type) {
                ...
                case DRAGON_TYPE: {
                    ...
                    if (Arrays.stream(DragonType.values()).noneMatch(el -> el.name().equals(dragonType))) {
                        callError(type.errorMessage);
                        continue;
                    }
                ...
                case DRAGON_CHARACTER: {
                    ...
                    if (Arrays.stream(DragonCharacter.values()).noneMatch(el -> el.name().equals(dragonCharacter))) {
                        callError(type.errorMessage);
                        continue;
                    }
                ...
                case KILLER_PASSPORT_ID: {
                    ...
                    boolean unique = collection.stream()
                            .map(el -> el.getKiller().getPassportID())
                            .noneMatch(el -> el.equals(passportID));
                    if (passportID.length() > 33 || !unique || passportID.isEmpty()) {
                        callError(type.errorMessage);
                        continue;
                    }
